<template>
  <BaseCard class="q-pa-lg">
    ...
    <div class="row items-center q-gutter-x-md q-mt-md justify-end">
      ...
      <PostIcon name="sym_o_favorite" :label="33" tooltip="좋아요" />
    ...
    <div>
      ...
      non sunt aspernatur deserunt quidem autem dolorem libero odit dignissimos,
      in repellendus molestiae saepe. Magnam provident quisquam officiis
      voluptatum consequuntur? <br />
      Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum, adipisci
      non sunt aspernatur deserunt quidem autem dolorem libero odit dignissimos,
      in repellendus molestiae saepe. Magnam provident quisquam officiis
      voluptatum consequuntur? <br />
